  ...
  return (
    <section className="py-10 px-4 md:px-10 lg:px-20 font-inter">
      ...
      <div className="text-center max-w-4xl mx-auto mb-16">
        <h2 className="text-3xl sm:text-4xl text-[#e86294] md:text-5xl brico tracking-tight leading-tight">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
        {/* Card 1 */}
        <div>
          <div className="border-2 border-dashed border-[#e86294] rounded-2xl p-6 text-center">
            <h3 className="text-7xl brico text-black">
              250<span className="text-[#e86294] text-7xl align-center">+</span>
            </h3>
