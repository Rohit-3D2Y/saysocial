  ...
  return (
    <div className="min-h-screen bg-[#F5F5F5] py-16 px-4 md:px-8 lg:px-16">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Description Section */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16 text-gray-600">
          <p className="text-lg font-semibold">
            BLOCKJOY STARTED AS A PROJECT TO MANAGE STAKING WITH FRIENDS AND FAMILY.
          </p>
          <div className="space-y-4">
            <p>
              We built advanced tooling to optimize validator management for teams of two. But, due to the sheer
              difficulty of installing and running nodes, our little VaaS company grew crazy fast.
            </p>
            <p>
              We quickly realized that VaaS can't work for a network because it centralizes control. We turned our
              platform into a SaaS tool so anyone could run their own node, with full control. BlockJoy just takes the
              headaches away.
            </p>
          </div>
        </div>
